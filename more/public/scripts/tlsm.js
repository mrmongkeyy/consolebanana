const config = {
	...
	toLoad:[
		{
			id:'attackingredmonster',
			type:'img',
			src:'/file?fn=attackingredmonster.png'
		},
		{
			id:'walkingredmonster',
			type:'img',
			src:'/file?fn=walkingredmonster.png'
		},
		{
			id:'idleredmonster',
			type:'img',
			src:'/file?fn=idleredmonster.png'
		},
		{
			id:'walkingbluemonster',
			type:'img',
			src:'/file?fn=walkingbluemonster.png'
		},
		{
			id:'idlebluemonster',
			type:'img',
			src:'/file?fn=idlebluemonster.png'
		},
		{
			id:'attacking_bm',
			type:'img',
			src:'/file?fn=attacking_bm.png'
		}
	]
}
